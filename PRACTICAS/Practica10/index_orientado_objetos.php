...
<table border="1px">
    ...
    if ($lindavista_conexion_error == null) {
        ...
        if ($resultado_consulta->num_rows > 0) {
            ...
            while($fila = $resultado_consulta->fetch_assoc()) {
                ...
                echo "\t\t\t<td>" . "<a href=\"" . $vivienda->getFoto() . "\"> <img src=\"imagenes/ico-fichero.png\" title=\"imagen\" name=\"imagen\"  height=\"30\" width=\"30\">" ."<a/></td>\n";
                echo "\t\t<tr>\n";
            }
        }
    ...
    echo "\n<br><a href=\"index.php\">Insertar otra vivienda</a>";
    ?>
</body>
</html>